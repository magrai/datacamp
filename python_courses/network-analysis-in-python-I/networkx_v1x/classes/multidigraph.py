...
from networkx_v1x.classes.graph import Graph  # for doctests
from networkx_v1x.classes.digraph import DiGraph
from networkx_v1x.classes.multigraph import MultiGraph

...
class BaseGraphTester(object):
    ...
    def test_neighbors_iter(self):
        ...
        assert_raises((KeyError,networkx_v1x.NetworkXError), G.neighbors_iter,-1)
    ...
    def test_edges_iter(self):
        ...
        assert_raises((KeyError,networkx_v1x.NetworkXError), f, -1)
    ...
    def test_nbunch_iter(self):
        ...
        assert_raises(networkx_v1x.NetworkXError,list,bunch)
...
class BaseAttrGraphTester(BaseGraphTester):
    ...
    def add_attributes(self,G):
        ...
        assert_raises(networkx_v1x.NetworkXError,G.add_edge,0,1,attr_dict=[])
    ...
    def test_attr_dict_not_dict(self):
        ...
        G=self.Graph()
        edges=[(1,2)]
        assert_raises(networkx_v1x.NetworkXError,G.add_edges_from,edges,
                      attr_dict=[])

    def test_to_undirected(self):
        G=self.K3
        self.add_attributes(G)
        H=networkx_v1x.Graph(G)
        self.is_shallow_copy(H,G)
        H=G.to_undirected()
        self.is_deepcopy(H,G)
...
class TestGraph(BaseAttrGraphTester):
    ...
    def test_getitem(self):
        ...
        assert_raises((TypeError,networkx_v1x.NetworkXError), G.__getitem__, ['A'])
    ...
    def test_add_node(self):
        ...
        assert_raises(networkx_v1x.NetworkXError, G.add_node, 4, [])
        assert_raises(networkx_v1x.NetworkXError, G.add_node, 4, 4)
    ...
    def test_remove_node(self):
        ...
        assert_raises((KeyError,networkx_v1x.NetworkXError), G.remove_node,-1)
    ...
    def test_add_edges_from(self):
        ...
        assert_raises(networkx_v1x.NetworkXError,

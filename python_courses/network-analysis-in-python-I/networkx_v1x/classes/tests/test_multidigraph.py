...
class BaseMultiDiGraphTester(BaseMultiGraphTester):
    def test_edges(self):
        ...
        assert_raises((KeyError,networkx_v1x.NetworkXError), G.edges,-1)
    ...
    def test_edges_data(self):
        ...
        assert_raises((KeyError,networkx_v1x.NetworkXError), G.neighbors,-1)
    ...
    def test_out_edges(self):
        ...
        assert_raises((KeyError,networkx_v1x.NetworkXError), G.out_edges,-1)
    ...
    def test_in_edges(self):
        ...
        assert_raises((KeyError,networkx_v1x.NetworkXError), G.in_edges,-1)
        G.add_edge(0,1,2)
        assert_equal(sorted(G.in_edges()),
                     [(0,1),(0,1),(0,2),(1,0),(1,2),(2,0),(2,1)])
    ...
    def test_successors(self):
        ...
        assert_raises((KeyError,networkx_v1x.NetworkXError), G.successors,-1)

    def test_successors_iter(self):
        G=self.K3
        assert_equal(sorted(G.successors_iter(0)),[1,2])
        assert_raises((KeyError,networkx_v1x.NetworkXError), G.successors_iter,-1)
    ...
    def test_predecessors(self):
        ...
        assert_raises((KeyError,networkx_v1x.NetworkXError), G.predecessors,-1)

    def test_predecessors_iter(self):
        G=self.K3
        assert_equal(sorted(G.predecessors_iter(0)),[1,2])
        assert_raises((KeyError,networkx_v1x.NetworkXError), G.predecessors_iter,-1)
    ...
    def test_degree(self):
        ...
        assert_raises((KeyError,networkx_v1x.NetworkXError), G.degree,-1)
    ...
    def test_in_degree(self):
        ...
        assert_raises((KeyError,networkx_v1x.NetworkXError), G.in_degree,-1)
    ...
    def test_out_degree(self):
        ...
        assert_raises((KeyError,networkx_v1x.NetworkXError), G.out_degree,-1)
    ...
    def test_reverse_copy(self):
        G=networkx_v1x.MultiDiGraph([(0,1),(0,1)])
        R=G.reverse()
...
class TestMultiDiGraph(BaseMultiDiGraphTester,TestMultiGraph):
    def setUp(self):
        self.Graph=networkx_v1x.MultiDiGraph
        # build K3
    ...
    def test_add_edges_from(self):
        ...
        assert_raises(networkx_v1x.NetworkXError, G.add_edges_from,[(0,)])  # too few in tuple
        assert_raises(networkx_v1x.NetworkXError, G.add_edges_from,[(0,1,2,3,4)])  # too many in tuple
    ...
    def test_remove_edge(self):
        ...
        assert_equal(G.pred,{0:{1:{0:{}}, 2:{0:{}}},
                             1:{2:{0:{}}},
                             2:{0:{0:{}},1:{0:{}}}})
        assert_raises((KeyError,networkx_v1x.NetworkXError), G.remove_edge,-1,0)
        assert_raises((KeyError,networkx_v1x.NetworkXError), G.remove_edge,0,2,
                      key=1)

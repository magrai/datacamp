...
class TestMultiGraph(BaseMultiGraphTester,TestGraph):
    def setUp(self):
        self.Graph=networkx_v1x.MultiGraph
        # build K3
        ed1,ed2,ed3 = ({0:{}},{0:{}},{0:{}})
    ...
    def test_add_edges_from(self):
        ...
        # too few in tuple
        assert_raises(networkx_v1x.NetworkXError, G.add_edges_from,[(0,)])
        # too many in tuple
        assert_raises(networkx_v1x.NetworkXError, G.add_edges_from,[(0,1,2,3,4)])

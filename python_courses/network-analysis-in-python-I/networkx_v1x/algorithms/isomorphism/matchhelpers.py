...
Examples
--------
>>> import networkx_v1x.algorithms.isomorphism as iso
...
>>> from networkx_v1x.algorithms.isomorphism.matchhelpers import close
>>> from networkx_v1x.algorithms.isomorphism import generic_node_match

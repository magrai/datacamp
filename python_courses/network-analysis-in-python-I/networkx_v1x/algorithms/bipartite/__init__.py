...
The bipartite algorithms are not imported into the import networkx_v1x namespace
at the top level so the easiest way to use them is with:

>>> import networkx_v1x as nx
>>> from networkx_v1x.algorithms import bipartite
...
from networkx_v1x.algorithms.bipartite.basic import *
from networkx_v1x.algorithms.bipartite.centrality import *
from networkx_v1x.algorithms.bipartite.cluster import *
from networkx_v1x.algorithms.bipartite.edgelist import *
from networkx_v1x.algorithms.bipartite.matching import *
from networkx_v1x.algorithms.bipartite.matrix import *
from networkx_v1x.algorithms.bipartite.projection import *
from networkx_v1x.algorithms.bipartite.redundancy import *
from networkx_v1x.algorithms.bipartite.spectral import *
from networkx_v1x.algorithms.bipartite.generators import *

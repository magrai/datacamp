...
from networkx_v1x.utils import open_file, make_str, not_implemented_for
from networkx_v1x.convert import _prep_create_using
...
def read_edgelist(path, comments="#",
    ...
    create_using : Graph container, optional,
       Use specified container to build graph.  The default is networkx_v1x.Graph,
       an undirected graph.
    ...
    -------
    G : graph
       A import networkx_v1x Graph or other type specified with create_using

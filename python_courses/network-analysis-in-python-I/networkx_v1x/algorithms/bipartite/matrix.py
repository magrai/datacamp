...
from networkx_v1x.convert_matrix import _generate_weighted_edges
...
def from_biadjacency_matrix(A, create_using=None, edge_attribute='weight'):
    ...
    If `create_using` is an instance of :class:`networkx_v1x.MultiGraph` or
    :class:`networkx_v1x.MultiDiGraph` and the entries of `A` are of type ``int``,

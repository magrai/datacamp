...
from networkx_v1x.algorithms.flow import edmonds_karp, shortest_augmenting_path
...
def local_node_connectivity(G, s, t, flow_func=None, auxiliary=None,
    ...
    >>> from networkx_v1x.algorithms.connectivity import local_node_connectivity
    ...
    >>> from networkx_v1x.algorithms.flow import shortest_augmenting_path
...
def local_edge_connectivity(G, u, v, flow_func=None, auxiliary=None,
    ...
    >>> from networkx_v1x.algorithms.connectivity import local_edge_connectivity

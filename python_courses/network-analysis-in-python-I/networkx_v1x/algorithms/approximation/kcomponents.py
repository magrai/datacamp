...
from networkx_v1x.exception import NetworkXError
from networkx_v1x.utils import not_implemented_for

from networkx_v1x.algorithms.approximation import local_node_connectivity
from networkx_v1x.algorithms.connectivity import \
    local_node_connectivity as exact_local_node_connectivity
from networkx_v1x.algorithms.connectivity import build_auxiliary_node_connectivity
from networkx_v1x.algorithms.flow import build_residual_network
...
def k_components(G, min_density=0.95):
    ...
    >>> from networkx_v1x.algorithms import approximation as apxa
    >>> G = nx.petersen_graph()

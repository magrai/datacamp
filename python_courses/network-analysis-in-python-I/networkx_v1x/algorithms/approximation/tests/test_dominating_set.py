...
from networkx_v1x.algorithms.approximation import min_weighted_dominating_set
from networkx_v1x.algorithms.approximation import min_edge_dominating_set

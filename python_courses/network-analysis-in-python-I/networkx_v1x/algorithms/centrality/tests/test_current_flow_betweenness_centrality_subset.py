...
from networkx_v1x import edge_current_flow_betweenness_centrality_subset \
...
class TestFlowBetweennessCentrality(object):
    ...
    def test_K4_normalized(self):
        ...
        b=networkx_v1x.current_flow_betweenness_centrality_subset(G,
                                                              G.nodes(),
                                                              G.nodes(),
                                                              normalized=True)
        b_answer=networkx_v1x.current_flow_betweenness_centrality(G,normalized=True)
        for n in sorted(G):
    ...
    def test_K4(self):
        ...
        b=networkx_v1x.current_flow_betweenness_centrality_subset(G,
                                                              ...
                                                              normalized=True,
                                                              weight='other')
        b_answer=networkx_v1x.current_flow_betweenness_centrality(G,normalized=True,weight='other')
        for n in sorted(G):
            assert_almost_equal(b[n],b_answer[n])

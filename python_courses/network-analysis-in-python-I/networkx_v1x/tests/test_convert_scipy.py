...
from networkx_v1x.testing import assert_graphs_equal
from networkx_v1x.generators.classic import barbell_graph,cycle_graph,path_graph
from networkx_v1x.testing.utils import assert_graphs_equal
...
class TestConvertNumpy(object):
    ...
    def test_from_scipy_sparse_matrix_parallel_edges(self):
        """Tests that the :func:`networkx_v1x.from_scipy_sparse_matrix` function
    ...
    def test_symmetric(self):
        ...
        :func:`networkx_v1x.from_scipy_sparse_matrix`.

...
from networkx_v1x.algorithms.isomorphism.isomorph import graph_could_be_isomorphic
from networkx_v1x.testing import assert_edges_equal
from networkx_v1x.testing import assert_nodes_equal
...
class TestGeneratorClassic():
    ...
    def test_barbell_graph(self):
        ...
        m1=1; m2=20
        assert_raises(networkx_v1x.exception.NetworkXError, barbell_graph, m1, m2)
    ...
    def test_circular_ladder_graph(self):
        ...
        assert_raises(networkx_v1x.exception.NetworkXError, circular_ladder_graph,
    ...
    def test_dorogovtsev_goltsev_mendes_graph(self):
        ...
        assert_raises(networkx_v1x.exception.NetworkXError,

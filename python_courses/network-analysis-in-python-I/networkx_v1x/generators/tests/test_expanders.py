...
"""Unit tests for the :mod:`networkx_v1x.generators.expanders` module.
...
from networkx_v1x import adjacency_matrix
from networkx_v1x import number_of_nodes
from networkx_v1x.generators.expanders import chordal_cycle_graph
from networkx_v1x.generators.expanders import margulis_gabber_galil_graph
...
def test_chordal_cycle_graph():
    """Test for the :func:`networkx_v1x.chordal_cycle_graph` function."""

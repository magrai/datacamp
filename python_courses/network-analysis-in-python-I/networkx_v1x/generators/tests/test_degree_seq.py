...
from networkx_v1x.generators.degree_seq import *
from networkx_v1x.utils import uniform_sequence,powerlaw_sequence
...
def test_random_degree_sequence_graph_raise():
    z=[1, 1, 1, 1, 1, 1, 2, 2, 2, 3, 4]
    assert_raises(networkx_v1x.exception.NetworkXUnfeasible,

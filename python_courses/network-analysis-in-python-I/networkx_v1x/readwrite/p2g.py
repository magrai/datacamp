...
#    BSD license.
import networkx
from networkx_v1x.utils import is_string_like,open_file
...
def read_p2g(path, encoding='utf-8'):
    ...
    use D=networkx_v1x.DiGraph(read_p2g(path))
    """
...
def parse_p2g(lines):
    ...
    G=networkx_v1x.MultiDiGraph(name=description,selfloops=True)

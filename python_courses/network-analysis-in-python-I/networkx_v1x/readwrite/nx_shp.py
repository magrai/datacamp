...
Generates a networkx_v1x.DiGraph from point and line shapefiles.
...
def read_shp(path, simplify=True):
    """Generates a networkx_v1x.DiGraph from shapefiles. Point geometries are
...
def write_shp(G, outdir):
    """Writes a networkx_v1x.DiGraph to two shapefiles, edges and nodes.

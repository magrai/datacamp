...
def _prep_create_using(create_using):
    ...
    If create_using is None return the default (just networkx_v1x.Graph())
    If create_using.clear() works, assume it returns a graph object.
    Otherwise raise an exception because create_using is not a import networkx_v1x graph.
    ...
    try:
        ...
        raise TypeError("Input graph is not a import networkx_v1x graph type")
    return create_using
